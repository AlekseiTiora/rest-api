...
//Read 8-12 defineerivad widgets nimelise massiivi, millel on 3 liiget, mis on objektid, millel on 3 atribuuti: id, name ja price Widget on kohatäite nimetus geneerilisele tootele. Näiteks kui meil oleks filmide andmebaas, siis oleks widget asemel vaja kasutada sõna movie.
const widgets = [
    { id: 1, name: "Erik", price: 29.99 },
    { id: 2, name: "Nikita", price: 26.99 },
    { id: 3, name: "Andrei", price: 59.99 },
]
...
//Read 25-38 defineerivad lõpp-punkti POST /widgets päringule, mis lisab kollektsiooni uue widgeti
